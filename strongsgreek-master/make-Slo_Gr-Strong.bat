...
REM %XMLLINT% --noout --schema teiP5osis.2.5.0.xsd c:\temp\sword M:\Strong\strongsgreek-master\strongsgreek-master\tei\slostronggreek.tei.xml


%C_DISK%                                           2>NUL
cd %C_DISK%\temp                                   2>NUL
mkdir sword\modules\lexdict\zld\slostrongsgreek    2>NUL
dir

c:\temp\sword\tei2mod.exe sword/modules/lexdict/zld/slostrongsgreek/ M:\Strong\strongsgreek-master\strongsgreek-master\tei\slostronggreek.tei.xml -z

mkdir c:\temp\sword\mods.d
copy M:\Strong\strongsgreek-master\slostrongsgreek.conf c:\temp\sword\mods.d

M:                                                 2>NUL
cd m:\Strong\strongsgreek-master                   2>NUL
