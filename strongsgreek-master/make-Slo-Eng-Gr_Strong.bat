...
%C_DISK%                                           2>NUL
cd %C_DISK%\temp                                   2>NUL
mkdir sword\modules\lexdict\zld\strongsgreek 2>NUL
dir

c:\temp\sword\tei2mod.exe sword/modules/lexdict/zld/strongsgreek/ m:\Strong\strongsgreek-master\strongsgreek-master\tei\merged_strongsgreek.tei.xml -z

mkdir c:\temp\sword\mods.d
copy M:\Strong\strongsgreek-master\strongsgreek.conf c:\temp\sword\mods.d
